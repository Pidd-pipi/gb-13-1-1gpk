...
- 按学科分类浏览
- 卖家主动联系买家
- 到货提醒：登录用户可对进行中的求购一键订阅/退订（每人每条求购仅一份订阅）；卖家上架新书后，系统按校区一致、售价不高于期望价、ISBN 相同（未填 ISBN 时按书名与作者）匹配并通知订阅者，同一本书对同一次订阅只提醒一次；个人中心可查看到货提醒、未读角标、标记已读并打开关联书籍，求购关闭后不再发送新提醒
